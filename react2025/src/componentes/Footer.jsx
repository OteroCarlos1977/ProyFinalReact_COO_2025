...
import { Container, Row, Col } from "react-bootstrap"; // Componentes de layout para estructurar el contenido

// Importación de íconos de redes sociales desde react-icons/fa6
import { FaFacebook, FaXTwitter, FaInstagram } from "react-icons/fa6";

// Componente funcional Footer que representa el pie de página de la aplicación
function Footer() {
    return (
        // Elemento <footer> con clases de Bootstrap para estilo: fondo oscuro, texto blanco, padding y margen superior
...
// Exportación del componente Footer para que pueda ser utilizado en otras partes de la aplicación
