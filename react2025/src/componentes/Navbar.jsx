                    ...
                    <Nav className="me-auto">
                        ...
                        {mostrarDropdown && (
                            <NavDropdown title="Productos" id="basic-nav-dropdown">
                                <NavDropdown.Item onClick={() => setCategoryFilter(null)}>Todos</NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setCategoryFilter("electronics")}>Informática</NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setCategoryFilter("men's clothing")}>Indumentaria Masculina</NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setCategoryFilter("women's clothing")}>Indumentaria Femenina</NavDropdown.Item>
                                <NavDropdown.Item onClick={() => setCategoryFilter("jewelery")}>Bijouterie</NavDropdown.Item>
                            </NavDropdown>
                        )}
                    </Nav>
                </Navbar.Collapse>
